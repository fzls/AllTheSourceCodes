...
public class chengjipaiming2 extends JFrame implements ActionListener {
...
Object col[]={"ID","NAME","GENDER","DEPARTMENT","REGION","RANK"};
JTable table;      //建表
//Connection ccon;
//Statement sql; ResultSet rs;

    public chengjipaiming2(String s) {
    	super(s);
      ...
      try{
         ...
         //   String fenshuduanrenshu=rs.getString(6);
           // Date ruxiaoshijian=rs.getDate(6);
            ...
            a[i][3]=s2;a[i][4]=xuenian;a[i][5]=i+1;
            i++;
           }pack();
           con.close();
